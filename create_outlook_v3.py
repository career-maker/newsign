...
# Get base64 for watermark (this one works in Outlook)
watermark_b64 = get_base64_image('watermark.png')
watermark_src = f'data:image/png;base64,{watermark_b64}' if watermark_b64 else ''

# Create very simple Outlook-compatible signature
...
<div style="margin-bottom: 16px;">
  ...
  <img src="{watermark_src}" alt="" style="height: 30px; width: auto; margin: 4px 0;">
</div>
...
output_path = Path(__file__).parent / 'outlook_signature_v3.html'
