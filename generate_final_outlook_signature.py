...
<div style="margin-bottom: 16px;">
  <img src="data:image/png;base64,{logo_png_b64}" alt="Sprint Logistics" style="height: 40px; width: auto; margin-bottom: 12px;">
...
with open('outlook_signature.html', 'w', encoding='utf-8') as f:
    f.write(html)

print(f'Generated outlook_signature.html with PNG logo')
